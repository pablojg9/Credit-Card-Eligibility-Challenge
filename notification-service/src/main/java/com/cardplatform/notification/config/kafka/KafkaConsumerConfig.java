package com.cardplatform.notification.config.kafka;
...
public class KafkaConsumerConfig {
  ...
  public ConsumerFactory<String, String> consumerFactory(final Environment env) {
    ...
    props.put(ConsumerConfig.GROUP_ID_CONFIG, env.getProperty("spring.kafka.consumer.group-id", "notification-service"));
